        ...
        <div class="col-md-8">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    ...
                    {{ __('Create your event here!') }}
                </div>
            </div>

            <div class="float-start">
                <h4 class="pb-3">{{ __('Create events') }}</h4>
            </div>
            <div class="float-end">
                ...
                <form action="{{ route('event.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="startAt" name="startAt" rows="5" placeholder="Enter start date and time"></input>
                            @error('startAt')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="endAt" name="endAt" rows="5" placeholder="Enter end date and time"></input>
                            @error('endAt')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
